...
public class NewFriendMsgAdapter extends ArrayAdapter<InviteMessage> {

	private Context context;
	private InviteMessgeDao messgeDao;

	public NewFriendMsgAdapter(Context context, int textViewResourceId, List<InviteMessage> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, R.layout.list_item_newfriend_msg, null);
		...
		new Thread(new Runnable() {
			public void run() {
				...
				try {
					...
					EventBus.getDefault().post(new InviteMessage());//当接受好友邀请时，更新通讯录
                    // update database
